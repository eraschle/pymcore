...
class TestElementRepositoryIntegration:
    ...
    def test_repository_save_and_load_single_element(self):
        ...
        element.set_parameter("material", "steel", UnitType.NONE, value_type=ValueType.STRING)
        ...
        assert loaded_element.get_parameter("height") == 12000.0
        assert loaded_element.get_parameter("material") == "steel"
        assert loaded_element.has_container("test_container")
    ...
    def test_repository_save_and_load_multiple_elements(self):
        ...
        pole.set_parameter("height", 12000.0, UnitType.MILLIMETER)
        
        foundation = GenericElement("foundation_001", "foundation")
        foundation.set_parameter("width", 2000.0, UnitType.MILLIMETER)
        foundation.set_parameter("length", 3000.0, UnitType.MILLIMETER)
        
        track = GenericElement("track_001", "track")
        track.set_parameter("length", 25000.0, UnitType.MILLIMETER)
        track.set_parameter("gauge", 1435.0, UnitType.MILLIMETER)
    ...
    def test_repository_object_references_system(self):
        ...
        pole.set_parameter("height", 15000.0, UnitType.MILLIMETER)
        
        foundation = GenericElement("foundation_456", "foundation")
        foundation.set_parameter("width", 2500.0, UnitType.MILLIMETER)
        ...
        assert referenced_foundation.get_parameter("width") == 2500.0
    ...
    def test_repository_file_save_and_load_json(self):
        ...
        foundation = GenericElement("foundation_001", "foundation")
        foundation.set_parameter("width", 2000.0, UnitType.MILLIMETER)
        foundation.set_parameter("concrete_grade", "C30/37", UnitType.NONE, value_type=ValueType.STRING)
        ...
        try:
            ...
            assert loaded_pole.get_parameter("height") == 12000.0
            ...
            assert loaded_foundation.get_parameter("width") == 2000.0
            assert loaded_foundation.get_parameter("concrete_grade") == "C30/37"
    ...
    def test_repository_query_operations(self):
        ...
        for i, elem in enumerate(elements):
            elem.set_parameter("sequence", i, UnitType.NONE, value_type=ValueType.INTEGER)
