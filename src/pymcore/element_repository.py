...
class ElementRepository:
    ...
    def __init__(self, container_registry: ContainerRegistry):
        ...
        self._object_references: dict[
            str, dict[str, str]
        ] = {}  # element_id -> {ref_name: target_path}
    ...
    def add_object_reference(
        self, source_element: GenericElement, reference_name: str, target_element: GenericElement
    ) -> None:
        """
        ...
        logger.debug(
            f"Added object reference '{reference_name}' from {source_element.element_id} to {target_element.element_id}"
        )

    def get_object_reference_info(
        self, element: GenericElement, reference_name: str
    ) -> dict[str, str] | None:
        """
    ...
    def reconstruct_container(
        self, element: GenericElement, container_type: str
